...
char LoadDefaultConfig(void)//加载默认配置
{
	...
	strcpy(config.wifi_ip.wip, "192.168.20.191");
	strcpy(config.wifi_ip.wip, "501");
	strcpy(config.wifi_info.ssid, "JM3399");
	strcpy(config.wifi_info.pwd, "12345678");
